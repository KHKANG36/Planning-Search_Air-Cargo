...
class AirCargoProblem(Problem):
    ...
    def actions(self, state: str) -> list:
        ...
        # Find possible actions and append it to the lists
    ...
    def result(self, state: str, action: Action):
        ...
        new_state.pos = [f for f in new_state.pos if f not in action.effect_rem]
        # Use effect_add 
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        count = 0
        all_state = decode_state(node.state, self.state_map) 
        # return the count of goals not achieved
        for g in self.goal:
            if g not in all_state.pos:
                count += 1
        return count
